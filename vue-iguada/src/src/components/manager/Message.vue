...
export default {
    data(){
        return{
            ...
            currentPage:1,
            users:[
                {id:1,userName:'123',email:'lha602@163.com',status:'正常',power:'普通用户',hasNew:true},
                {id:2,userName:'11234',email:'lha602@163.com',status:'正常',power:'普通用户',hasNew:false},
                {id:3,userName:'abc',email:'lha602@163.com',status:'正常',power:'普通用户',hasNew:true}
            ],
        }
    },
    methods:{
