            ...
            <el-table :data="admins">
                ...
                <el-table-column label="操作" width="100">
                    <template slot-scope="scope">
                        <el-badge is-dot class="item" v-if="scope.row.hasNew">
                            <el-button @click="communicate(scope.row.userName,scope.row.id)" type="text" size="small">联系</el-button>
                        </el-badge>
                        <el-button @click="communicate(scope.row.userName,scope.row.id)" type="text" size="small" v-else>联系</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </div>
...
export default {
    data(){
        return{
            ...
            currentPage:1,
            admins:[
                {id:1,userName:'admin',email:'lha602@163.com',status:'正常',power:'管理员',hasNew:true},
                {id:2,userName:'admin1',email:'lha602@163.com',status:'正常',power:'管理员',hasNew:false},
                {id:3,userName:'admin2',email:'lha602@163.com',status:'正常',power:'管理员',hasNew:false}
            ],
        }
    },
    methods:{
