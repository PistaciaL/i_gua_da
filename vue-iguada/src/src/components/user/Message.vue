...
export default {
    data(){
        return{
            ...
            currentPage:1,
            admins:[
                {id:1,userName:'admin',email:'lha602@163.com',status:'正常',power:'管理员'},
                {id:2,userName:'admin1',email:'lha602@163.com',status:'正常',power:'管理员'},
                {id:3,userName:'admin2',email:'lha602@163.com',status:'正常',power:'管理员'}
            ],
        }
    },
    methods:{
